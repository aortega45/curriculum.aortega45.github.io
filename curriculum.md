...
[hola](https://www.mipsfundacio.com/)
- Suport a l'usuari
...
- **Programació:** Python, C (35%)
- **Administració de Sistemes:** Windows (88%), Linux (64%)
- **Xarxes:** Protocols de xarxa (76%), Configuració i administració de xarxes (63%), Monitorització i seguretat de xarxes (50%)
